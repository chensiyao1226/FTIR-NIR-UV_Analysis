...
Edge1H = 1500; Edge1Hnum=100 ##minEdge
Edge2L = 1500; Edge2Lnum=10000 ##maxEdge
Edge2H = 1620; Edge2Hnum=100 ##maxEdge
...
for i in range(1,content_cutted.shape[0]):
    savgol[i]=savgol_filter(content_cutted[i], window_length = 15, polyorder = 5, deriv = 2)
