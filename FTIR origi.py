...
#=========cut================
Edge1 = 900; Edge1num=10000 ##minEdge
Edge2 = 1900; Edge2num=100 ##minEdge
...
for i in range (len(content_matrix[0])):
    if((content_matrix[0][i]>Edge1) and (i<Edge1num)):
        Edge1num = i
    if ((content_matrix[0][i] < Edge2) and (i > Edge2num)):
        Edge2num = i




content_cutted=[x[Edge1num:Edge2num] for x in content_matrix]
...
for i in range(1,content_cutted.shape[0]):
    savgol[i]=savgol_filter(content_cutted[i], window_length = 25, polyorder = 5, deriv = 2)
